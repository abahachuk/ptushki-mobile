  ...
  <ScrollView showsVerticalScrollIndicator={false} style={styles.container}>
    <View style={styles.margin}>
      <View style={styles.logo}>
        ...
        <Text style={styles.version}>{`${translate('aboutApp.version')} ${version}`}</Text>
      </View>
      ...
      <View style={styles.article}>
        ...
        <Text style={styles.text}>{translate('aboutApp.aboutCenterDescription')}</Text>
      </View>
    </View>
    <View style={styles.contactDetails}>
      <Text style={styles.contactDetailsTitle}>{translate('aboutApp.contactDetails')}</Text>
      <View style={styles.contactDetailsItem}>
        <Text style={styles.contactDetailsLabel}>{translate('aboutApp.phone')}</Text>
        <Text style={styles.contactDetailsInput}>{phone}</Text>
      </View>
      <View style={styles.contactDetailsItem}>
        <Text style={styles.contactDetailsLabel}>{translate('aboutApp.email')}</Text>
        <Text style={styles.contactDetailsInput}>{email}</Text>
      </View>
    </View>
    <View style={styles.developApp}>
      <View style={styles.article}>
        <Text style={styles.title}>{translate('aboutApp.developmentTitle')}</Text>
        <Text style={styles.text}>{translate('aboutApp.developmentDescription')}</Text>
      </View>
